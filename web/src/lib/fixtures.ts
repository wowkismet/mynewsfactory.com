 ...
 *
 * These are seed data, not content (§81, docs/DECISIONS.md D-010). They exist
 * to make development and tests reproducible. They are inserted by
 * `db/seed.ts` in development and test only; production reads the database and
 * fails to start rather than serving invented articles under real reporter
 * names.
 */
