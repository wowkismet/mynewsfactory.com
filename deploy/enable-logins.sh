...
echo
echo "Note: an administrator account requires a second factor, and the endpoint"
echo "that accepts one is not built yet (Phase 1d). Until then it can sign in"
echo "but not act — keep using a reader account for now."
